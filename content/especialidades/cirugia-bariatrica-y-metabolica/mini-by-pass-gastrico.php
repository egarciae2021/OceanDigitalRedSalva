	...
	<div class="container pt-3 mb-n5">
		<div class="row">
			...
			<div class="mb-0">
				...
				<a class="link color-white color-naranja-hover ms-3" href="/especialidades/cirugia-bariatrica-y-metabolica"><i class="fa fa-arrow-left small me-1"></i> Cirugía Bariátrica y Metabólica</a>
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-10 col-md-7 col-lg-6 offset-1 offset-md-0 content-space-md-1">
				<div class="position-relative fondo-celeste-bajo rounded-3 zi-1 p-6 mt-5 mb-5 pe-6  shadow-sm">
					...
					<div class="mb-5">
						...
						<a class="link color-azul color-naranja-hover ms-3" href="/especialidades/cirugia-bariatrica-y-metabolica"><i class="fa fa-arrow-left small me-1"></i> Cirugía Bariátrica y Metabólica</a>
					</div>
				</div>
			</div>
		</div>
