		...
		<div class="row position-relative">
			<div class="position-md-absolute top-0 col-md-7 offset-md-5 h-100">
				<div class="bg-img-center card-img">
					<img class="img-fluid rounded-3" style="height:400px !important" src="/images/Especialidades/Neumologia.jpg">
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				...
				<p>Nos comprometemos a mejorar la calidad de vida de nuestros pacientes a través de una atención comprensiva y compasiva. Desde el manejo del asma y el EPOC hasta el tratamiento de infecciones pulmonares y trastornos del sueño, en la Clinica Red Salva estamos dedicados a proporcionar un cuidado respiratorio de excelencia, asegurando que nuestros pacientes reciban la mejor atención posible en cada etapa de su tratamiento.</p>
