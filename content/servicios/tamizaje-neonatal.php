	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>s el proceso de aplicación de procedimientos a bebés recién nacidos, aparentemente sanos, con el objetivo de identificar oportunamente posibles enfermedades graves; y así prevenir discapacidad física y mental.</p>
				<p class="color-azul h5">LEY DE OBLIGATORIEDAD DE TAMIZAJE</p>
				<p>Desde el 2013, el Ministerio de Salud emitió la Ley 29885, en la que se declara la Obligatoriedad del Tamizaje; tanto en centros de salud públicos como privados.</p>
				<p class="color-azul h5">BENEFICIOS</p>
				<ul>
					<li>Prevención</li>
					<li>Tratamiento oportuno</li>
					<li>Salud y calidad de vida para su bebé</li>
					<li>Desarrollo y crecimiento sin complicaciones</li>
				</ul>
			</div>
		</div>
	</div>
