    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Usamos cookies para mejorar tu experiencia de navegación, mostrarte anuncios personalizados y
                    analizar nuestro tráfico. Puedes personalizar tus preferencias.
                </p>
...
<div id="cookie-preferences-modal" class="modal fade" tabindex="-1" aria-labelledby="preferencesModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Usamos cookies para ayudarte a navegar de manera eficiente y realizar ciertas funciones. Aquí puedes
                    gestionar las categorías de cookies que deseas permitir:
                </p>

                <!-- Categoría: Necesarias -->
                <div class="mb-3">
                    <h6>Necesarias <span class="text-success">Siempre activas</span></h6>
                    <p>Estas cookies son esenciales para el funcionamiento básico del sitio y no pueden desactivarse.
                    </p>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="functional-cookies">Activar cookies
                                    funcionales</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="analytics-cookies">Activar cookies
                                    analíticas</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <h6>Rendimiento</h6>
                            <p>Estas cookies mejoran el rendimiento del sitio web al optimizar recursos y tiempos de
                                carga.</p>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="performance-cookies">
                                <label class="form-check-label" for="performance-cookies">Activar cookies de
                                    rendimiento</label>
                            </div>
                        </div>
